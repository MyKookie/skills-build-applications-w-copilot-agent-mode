...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            team1.save()
            team2.save()
            print('Teams created:', Team.objects.count())
        except Exception as e:
            print('Error creating teams:', e)
        for user in users:
        ...
        try:
            ...
            print('Activities created:', Activity.objects.count())
        except Exception as e:
        ...
        try:
            ...
            print('Leaderboard entries created:', Leaderboard.objects.count())
        except Exception as e:
            print('Error creating leaderboard entries:', e)
        ...
        try:
            ...
            print('Workouts created:', Workout.objects.count())
        except Exception as e:
            print('Error creating workouts:', e)
